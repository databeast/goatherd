...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.goatherd.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".goatherd" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".goatherd")
	}
