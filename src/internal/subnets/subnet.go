...
type Subnet struct {
	...
	Mask uint32 // base Integer for XOR masking matching comm to this subnet (ie the subnet Mask)

	ObservedCount int       // how many incoming comm have matched this Potential Subnet?
